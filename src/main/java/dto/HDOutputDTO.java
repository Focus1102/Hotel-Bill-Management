...
public class HDOutputDTO {
    ...
    public HDOutputDTO(int maHD, Date ngayHD, String hoTen, String kHD, double donGia, int soGioThue, int soNgayThue, int thanhTien) {
        if (maHD <= 0) {
    ...
    public String toString() {
        return String.format("Hóa đơn #%d - %s - %s - %.2fđ - %s - %.2fđ", 
            maHD, hoTen, ngayHD, donGia, 
            kHD.equals("SG") ? soGioThue + " giờ" : soNgayThue + " ngày",
            thanhTien);
    }
}